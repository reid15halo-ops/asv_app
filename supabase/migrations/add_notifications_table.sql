...
-- Erstelle notification_type Enum
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  -- Referenzen zu anderen Entities (optional)
...
COMMENT ON COLUMN notifications.event_id IS 'Referenz zu Event (falls relevant)';
...
-- In Production: Notifications werden via Backend/Trigger erstellt
...
-- Trigger: Automatische Notification bei neuem Event
...
COMMENT ON FUNCTION notify_users_on_new_event IS 'Sendet Notifications an alle User wenn ein neues Event erstellt wird';
